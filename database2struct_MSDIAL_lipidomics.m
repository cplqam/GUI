...
database = struct('NAME', name, 'PRECURSORMZ', precursor, 'PRECURSORTYPE', adduct, 'IONIZATION', ionization, 'RETENTIONTIME', rt, 'CCS', css, 'FORMULA', formula, 'SMILES', smiles, 'INCHIKEY', inchi, 'MS2', ms2); 
end